...
// 2. CONSULTA MEJORADA: Traemos los nombres de los insumos para que el buscador sea inteligente
...
<body>
    ...
    <div class="main">
        ...
        <div class="search-container">
            ...
            <input type="text" id="recipeSearch" class="form-control" onkeyup="filterRecipes()" placeholder="Buscar por nombre de mezcla o por insumo (ej: LESS, Sosa, Colorante)...">
        </div>
                    ...
                    <tr class="recipe-row" style="border-bottom: 1px solid #eee;">
                        <td style="padding: 15px;">
                            ...
                            <span class="insumos-preview">
                                ...
                                <?php echo $f['lista_insumos'] ? mb_strimwidth($f['lista_insumos'], 0, 80, "...") : 'Sin ingredientes configurados'; ?>
                            </span>
                        </td>
    ...
    <script>
        function filterRecipes() {
            ...
            for (let i = 0; i < rows.length; i++) {
                ...
                // Filtra si el input está en el nombre O en la lista de insumos
